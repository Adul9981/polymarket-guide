export default function SocialFooter() {
  ...
  return (
    <footer className="mt-16 pt-8 border-t border-[#2d2f36]">
      {/* Social links */}
      <div className="flex flex-wrap justify-center gap-3 mb-6">
        {links.map((link) => (
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-white bg-[#1a1b1e] hover:bg-[#2d2f36] border border-[#2d2f36] hover:border-[#3d3f46] rounded-lg px-4 py-2 transition-all"
          >
            {link.icon}
            {link.label}
          </a>
      ...
      <p className="text-center text-xs text-slate-600 leading-relaxed">
        加入群组反馈问题 · 添加好友持续交流 · 欢迎分享给对预测市场感兴趣的朋友
      </p>
